	...
	public function __construct() {
        ...
        public function getDefinition($extensionName = 'com_k2', $content = null, $params = null) {
                ...
                if (!$params) {
                        ...
                        $plugin = JPluginHelper::getPlugin('komento', 'rate');
                ...
                $definition = self::parseCriterias($content, $groups, $criterias, $separator, $showAs);
        ...
        private static function parseCriterias($catId, $groups, $criterias, $separator, $showAs) {
                ...
                if (is_object($catId)) {
                        $cat = JprovenUtility::nize($catId->catname, 1);
                        $tokenValues = array($catId->title, $cat);
                        $catId = $catId->catid;
                } else {
                        $tokenValues = array();
                }
