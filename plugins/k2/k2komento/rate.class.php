...
';
        ...
        public function form() {
                ...
                $document->addStyleSheet(JURI::root().'media/plg_k2_k2komento/rate.css');
                $document->addScript(JURI::root().'media/plg_k2_k2komento/rate.js');
                $document->addScript(JURI::root().'media/plg_k2_k2komento/MooStarRating/Source/moostarrating.js');
                ...
                window.addEvent('load', function(){ 
                        new K2KomentoRate({
                                base:'".JURI::root()."media/plg_k2_k2komento/',
