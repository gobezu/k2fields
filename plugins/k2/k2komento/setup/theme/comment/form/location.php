...
if( $system->config->get( 'enable_location' ) && $system->config->get( 'show_location' ) ) { ?>
	<div class="locationForm kmt-form-location">
		<input id="register-location" class="locationInput input text kmt-location" type="text" value="<?php echo JText::_( 'COM_KOMENTO_COMMENT_WHERE_ARE_YOU' ); ?>" name="address" />
