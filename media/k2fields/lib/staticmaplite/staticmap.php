...
Class staticMapLite {
	...
	public function __construct(){
		...
		$this->maptype = $this->tileDefaultSrc;
                $this->tileCacheBaseDir = dirname(__FILE__).'/../../../../cache/k2fields_staticmap/tiles';
                $this->mapCacheBaseDir = dirname(__FILE__).'/../../../../cache/k2fields_staticmap/maps';
	}
	...
	public function placeMarkers(){
		foreach($this->markers as $marker){
			...
			$markerIndex++;
                        $markerFilename = dirname(__FILE__).'/../../icons/numbers/'.$markerImage.($markerIndex<10?'0':'').$markerIndex.'.png';
                        if (file_exists($markerFilename)) {
