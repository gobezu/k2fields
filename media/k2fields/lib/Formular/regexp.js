if (!this.Formular) this.Formular = {};

var JProvenRegExp;

JProvenRegExp = this.Formular.RegExp = {
	...
	host: function(/*Object?*/flags){
		...
		if(flags.allowIP){ hostNameRE += "|" +  dJProvenRegExp.ipAddress(flags); }
	...
	url: function(/*Object?*/flags){
		...
		return protocolRE + dJProvenRegExp.host(flags) + pathRE;
	},
	...
	emailAddress: function(/*Object?*/flags){
		...
		var emailAddressRE = usernameRE + "@" + dJProvenRegExp.host(flags);
	...
	emailAddressList: function(/*Object?*/flags){
		...
		var emailAddressRE = dJProvenRegExp.emailAddress(flags);
...
this.Formular.isIpAddress = function(/*String*/value, /*Object?*/flags) {
	...
	var re = new RegExp("^" + JProvenRegExp.ipAddress(flags) + "$", "i");
	return re.test(value); // Boolean
};


this.Formular.isUrl = function(/*String*/value, /*Object?*/flags) {
	...
	var re = new RegExp("^" + JProvenRegExp.url(flags) + "$", "i");
	return re.test(value); // Boolean
};

this.Formular.isEmailAddress = function(/*String*/value, /*Object?*/flags) {
	...
	var re = new RegExp("^" + JProvenRegExp.emailAddress(flags) + "$", "i");
	return re.test(value); // Boolean
};

this.Formular.isEmailAddressList = function(/*String*/value, /*Object?*/flags) {
	...
	var re = new RegExp("^" + JProvenRegExp.emailAddressList(flags) + "$", "i");
	return re.test(value); // Boolean
};

this.Formular.getEmailAddressList = function(/*String*/value, /*Object?*/flags) {
	...
	if (this.Formular.isEmailAddressList(value, flags) ) {
