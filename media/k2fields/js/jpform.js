...
var JPForm = new Class({
        ...
        createListSelect: function(values, valName, txtName, id, name, firstElementTxt, isMultiple, size, place) {
                if (isMultiple && name) {
                        name += '[]';
                }
                
                return this._createListElement('select', values, {id:id, name:name, firstElement:firstElementTxt, multiple:isMultiple?'multiple':'', size:size}, valName, txtName, undefined, place);
        },
        ...
        createListInput: function(type, values, attrs, place, valName, txtName, imgName) {
                ...
                return this._createListElement(type, values, attrs, valName, txtName, imgName, place);
        },
        
        addValue: function(el, value, activate, caseSensitive, matchMethod, autoGenerated, group, place) {
                if (!el || !value) return;
                ...
                if (type == 'select') {
                        opt = this._createListElementOption(type, value, activate, undefined, undefined, undefined, undefined, group ? group : el);
                        ...
                        opt = this._createListElementOption(el.get('type'), value, activate, id, name, lblPos, undefined, place);
        ...
        addValues: function(el, values, addElToResult) {
                ...
                for (var i = 0; i < values.length; i++) {
                        result.push(this.addValue(el, values[i], undefined, undefined, undefined, true));
                }
...
//                }
        ...
        /* resetValue : set to default value */
        ...
        _createListElementOption: function(type, value, activate, id, name, lblPos, attrs, place) {
                var opt;
         ...
         */
        _createListElement: function(type, values, attrs, valName, txtName, imgName, place) {
                if (!values || values.length == 0) return;
                
                values = this.getValues(values);
                
                var el, value, grp, pos = 0, id, name, result = [];
                ...
                if (type == 'select') {
                        ...
                        el = this._createListElementOption(type, value, false, id, name, undefined, attrs, place);
                        pos = 1;
                }
                ...
                while (pos < values.length) {
                        ...
                        this.addValue(el, value, undefined, undefined, undefined, true, grp, place);
