...
abstract class JHtmlBehavior
{
	...
	public static function calendar()
	{
                ...
                $theme = K2FieldsModelFields::setting('datepickertheme', null, 'dashboard');
                
                JprovenUtility::loc(true, true, 'lib/datepicker/'.$theme.'/'.$theme.'.css', true, 'css');
                
                JprovenUtility::load('calendardatepickerbridge.js', 'js');
                
                JFactory::getDocument()->addScriptDeclaration('window.addEvent("domready", function() {Calendar.theme="'.$theme.'"});');
	}
