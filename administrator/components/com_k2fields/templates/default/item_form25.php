...
// Changes: Additional parameters for K2item at the bottom of the parameter pane
/**
 * @version		$Id: default.php 891 2011-07-27 15:14:22Z lefteris.kavadas $
 * @package		K2
...
$this->assignRef('k2itemform', $k2itemForm);
						...
						<td id="adminFormK2Sidebar"<?php if($this->mainframe->isSite() && !$this->params->get('sideBarDisplayFrontend')): ?> style="display:none;"<?php endif; ?> class="xmlParamsFields">
							...
							<div id="k2Accordion">
								...
								<div>
									<fieldset class="panelform">
										<ul class="adminformlist">
											<?php foreach($this->k2itemform->getFieldset('k2item-item-view-options-listings') as $field): ?>
											<li>
												<?php if($field->type=='header'): ?>
												<div class="paramValueHeader"><?php echo $field->input; ?></div>
												<?php elseif($field->type=='Spacer'): ?>
								...
								<div>
									<fieldset class="panelform">
										<ul class="adminformlist">
											<?php foreach($this->k2itemform->getFieldset('k2item-item-view-options') as $field): ?>
											<li>
												<?php if($field->type=='header'): ?>
												<div class="paramValueHeader"><?php echo $field->input; ?></div>
												<?php elseif($field->type=='Spacer'): ?>
