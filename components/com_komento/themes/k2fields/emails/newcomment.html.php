...
<body style="margin:0;padding:0;background:#ddd;">
	...
	<center style="display:block;padding:30px 0">
			...
			<tbody>
				<tr>
					<td style="padding:20px;border-bottom:1px solid #b5bbc1;;background:#f5f5f5;border-radius:3px 3px 0 0;-moz-border-radius:3px 3px 0 0;-webkit-border-radius:3px 3px 0 0;<?php echo $document->direction == 'rtl' ? 'text-align:right;' : ''; ?>">
						...
						<br /><br />
						<?php echo JText::_( 'COM_KOMENTO_NOTIFICATION_NEW_COMMENT_POSTED' ); ?>
						<br />
				...
				<tr>
					<td style="padding:15px 20px;line-height:1.5;color:#555;font-family:'Lucida Grande',Tahoma,Arial;font-size:12px;text-align:<?php echo $document->direction == 'rtl' ? 'right' : 'left'; ?>">
						...
						<div style="color:#555;clear:both;border-top:1px solid #ddd;padding:20px 0 10px">
							<a href="<?php echo $commentPermalink;?>" target="_blank" style="display:inline-block;padding:5px 15px;background:#fc0;border:1px solid #caa200;border-bottom-color:#977900;color:#534200;text-shadow:0 1px 0 #ffe684;font-weight:bold;box-shadow:inset 0 1px 0 #ffe064;-moz-box-shadow:inset 0 1px 0 #ffe064;-webkit-box-shadow:inset 0 1px 0 #ffe064;border-radius:2px;moz-border-radius:2px;-webkit-border-radius:2px;text-decoration:none!important">
								<?php echo JText::_( 'COM_KOMENTO_NOTIFICATION_VIEW_COMMENT' ); ?>
							</a>
						</div>
					</td>
				</tr>
		...
		<?php if( isset($options['recipient']->subscriptionid ) ) { ?>
		<p>
			<?php echo JText::_( 'COM_KOMENTO_NOTIFICATION_UNSUBSCRIBE_TEXT' ); ?><br /><?php echo JText::_( 'COM_KOMENTO_NOTIFICATION_UNSUBSCRIBE' ); ?>, <a href="<?php echo $unsubscribe . $options['recipient']->subscriptionid; ?>" style="color:#477fda"><?php echo JText::_( 'COM_KOMENTO_NOTIFICATION_UNSUBSCRIBE_HERE' );?></a>.
		</p>
		<?php } ?>
	</center>
