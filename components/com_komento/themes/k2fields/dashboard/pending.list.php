...
<thead>
	<tr>
		...
		<th><?php echo JText::_( 'COM_KOMENTO_COLUMN_ACTION' ); ?></th>
	</tr>
</thead>
<tbody>
<?php
if($comments)
{
	...
	foreach($comments as $row)
	{
		...
		$this->set( 'i', $i );
		echo $this->fetch( 'dashboard/pending.item.php' );

		$i++;
	}
} else { ?>
	<tr>
		<td colspan="3"><?php echo JText::_( 'COM_KOMENTO_COMMENTS_NO_COMMENT' ); ?></td>
	</tr>
<?php } ?>
</tbody>
</table>
